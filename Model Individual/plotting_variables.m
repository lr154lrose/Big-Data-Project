answer = 0;
figure_not_displayed = true;

if(figure_not_displayed)
    figure_not_displayed = false;
    ...
    for i = 1:7
        ...
        for t = 1:length(time)
            ...
            surfm(Y, X, unknown','FaceAlpha', 0.75); 
            load coastlines
            ...
            drawnow
            %delete(outline);
            cla %used to clear out the figure inbetween plots
        end
    end
end
